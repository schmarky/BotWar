...
/**
 * An extension of GameImage, GameUi represents a UI element provided for the
 * user.
 * 
 * In addition to the GameImage properties, UI elements include a state
 * identifier, allowing buttons to appear in different states with associated
 * drawables.
 * 
